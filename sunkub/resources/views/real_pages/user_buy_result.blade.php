...
@section('content')
    <div class="cardliststock mx-8 mt-8 flex flex-col h-screen px-4 ">
        ...
        @if ($success)
            ...
            <div class="bg-zinc-800 mt-3 rounded-t-xl h-full px-5 pt-4">
                ...
                <div class="grid grid-rows-3 justify-items-center">
                    <div class="text-white opacity-50">คุณส่งคำสั่งซื้อหุ้น {{ $stock_symbol }} แบบใช้ราคาตลาด</div>
        ...
        @else
            <div class="ml-3">
                <div class=" text-3xl text-white">
                    เสียใจด้วย ! การสั่งซื้อของคุณไม่สำเร็จแล้ว
                </div>
                <div class="text-base mt-2 text-thin text-gray-200 opacity-75">
                    กรุณาตรวจสอบรายละเอียดการสั่งซื้ออีกครั้ง
                </div>
            </div>
            ...
            <div class="bg-zinc-800 mt-3 rounded-t-xl h-full px-5 pt-4">
                ...
                <div class="grid grid-rows-3 justify-items-center">
                    @if ($insufficient_funds)
                        <div class="text-white opacity-50">ยอดเงินไม่เพียงพอสำหรับการซื้อหุ้น</div>
                        <div class="text-white opacity-50 pt-1">โปรดตรวจสอบยอดเงินก่อนซื้อ</div>
                    @endif
                    @if ($stock_not_found)
