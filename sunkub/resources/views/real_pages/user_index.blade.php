...
@section('content')
<div class="flex flex-col h-screen " id="loaditem">
...
<div id="pagecontent" class="content fadecontent h-full" >
    ...
    <div class="cardstock pt-4 grid justify-items-center">
        <div> <!-- TradingView Widget BEGIN -->
            <div class="tradingview-widget-container">
                <div class="tradingview-widget-container__widget"></div>
                <div class="tradingview-widget-copyright"><a href="https://th.tradingview.com/" rel="noopener nofollow"
                        target="_blank"><span class="white200">ติดตามตลาดทั้งหมดได้บน
