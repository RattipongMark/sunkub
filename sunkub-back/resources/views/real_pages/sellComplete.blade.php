...
@section('content')
    <div class="bg-neutral-700 m-5 rounded-xl">
        ...
        <div class="grid grid-row-2 mx-5 mt-4">
            ...
            <div class="bg-zinc-800 mt-3 rounded-xl h-auto grid grid-rows-2">
                <div class="flex justify-center mt-36">
                    <img src="images/checkCircle_violet.svg">
                </div> 
                <div>
                    <p class="text-white flex justify-center mt-3 opacity-80">คุณได้ส่งข้อเสนอการขายหุ้น AAPL แบบใช้ราคาตลาด</p>
