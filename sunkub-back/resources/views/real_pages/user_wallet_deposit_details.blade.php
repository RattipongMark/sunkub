    ...
    <div class="mx-5 mt-4 min-h-dvh h-auto">
        <div class="ml-3">
            ...
            <div class="bg-zinc-800 rounded-xl flex flex-col items-center p-5 mt-3 mr-5">
                <select class="select text-center text-opacity-50 w-full max-w-xs text-black bg-white" id="card-select">
                ...
                <div class="bg-zinc-800 rounded-xl flex flex-col items-center p-5 mt-3 mr-5">
                    ...
                    <div class="grid grid-cols-3 mt-2 gap-2 w-1/2">
                        <label class="input input-bordered flex items-center gap-2 bg-white">
                            <input type="text" class="grow bg-white w-1/2" placeholder="xx" />
                        </label>
                        <label class="input input-bordered flex items-center gap-2 bg-white">
                            <input type="text" class="grow bg-white w-1/2" placeholder="xx" />
                        </label>
                        <label class="input input-bordered flex items-center gap-2 bg-white">
                            <input type="text" class="grow bg-white w-1/2" placeholder="xxx" />
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div id="amount-form" style="display:none;">
                <div class="bg-zinc-800 rounded-xl flex flex-col items-center p-5 mb-5 mt-3 mr-5">
                    ...
                    <div class="border-dashed border-l-2 border-r-2 border-b-2 border-white border-opacity-50 rounded-b-xl p-4 w-3/5">
                            ...
                            <div class="bg-violet-400 rounded-xl p-3 mt-2 mb-2">
                                <div class="grid grid-cols-3">
                                    ...
                                    <div class="flex flex-row items-center justify-end col-span-2">
                                        ...
                                        <input type="checkbox" class="checkbox checkbox-bg-white border-black" onchange="toggleInput(this, 'portfolio-1-input')"/>
                                    </div>
                                </div>
                            </div>
                            <div class="flex flex-col items-center mb-2" id="portfolio-1-input" style="display:none;">
                                <div class="text-white text-left w-3/4">
                                    จำนวนเงิน
                                </div>
                                <label class="input input-bordered flex items-center gap-2 bg-white mt-2 w-3/4">
                                    <input type="text" class="grow bg-white text-sm" placeholder="ใส่จำนวนเงินที่คุณต้องการฝาก" />
                            ...
                            <div class="bg-violet-400 rounded-xl p-3 mt-2 mb-2">
                                <div class="grid grid-cols-3">
                                    ...
                                    <div class="flex flex-row items-center justify-end col-span-2">
                                        ...
                                        <input type="checkbox" class="checkbox border-black" onchange="toggleInput(this, 'portfolio-2-input')"/>
                                    </div>
                                </div>
                            </div>
                            <div class="flex flex-col items-center mb-2" id="portfolio-2-input" style="display:none;">
                                <div class="text-white text-left w-3/4">
                                    จำนวนเงิน
                                </div>
                                <label class="input input-bordered flex items-center gap-2 bg-white mt-2 w-3/4">
                    ...
                    <div class="flex justify-end mt-4 w-3/5">
                        <a href="" class="bg-violet-300 mb-3 rounded-xl hover:bg-violet-400 p-2 text-lg text-black">ชำระเงิน</a>
                    </div>
                </div>
            </div>
        </div>
