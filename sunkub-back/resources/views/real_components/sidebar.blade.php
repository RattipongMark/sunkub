...
<body>
    ...
    <div class="bg-zinc-500 flex ">
        ...
        <div class="flex-1 h-full justify-items-end">
            <div class="navbar bg-zinc-800 text-white flex justify-between  pl-5 pr-5 navpo">
                <div>@yield('contentnav')</div>
                <div class="dropdown dropdown-end pr-4">
                    <div tabindex="0" role="button">test</div>
                    <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow bg-violet-950 rounded-box w-36 mt-4">
